...
weights["model"] = OrderedDict((k.replace("encoder.layers.11", "extractor") if k in old_keys else k, v) for k, v in weights["model"].items())
torch.save(weights, "data/bart.with.extractor.large/model.pt")