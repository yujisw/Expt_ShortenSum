...
def main(args):
    ...
    if args.freeze_pretrained:
        # freeze pretrained weights (encoder, decoder, and classification_heads)
    ...
    if args.model_parallel_size == 1:
        trainer = MyTrainer(args, task, model, criterion, quantizer)
    else:
    ...
    while lr > args.min_lr and epoch_itr.next_epoch_idx <= max_epoch:
        ...
        if args.task == "proposal_task" and args.topk_eps_decay and epoch_itr.next_epoch_idx > 1 and topk_eps > 0.000001:
