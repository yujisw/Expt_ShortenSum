...
from modeling_proposal import ProposalForConditionalGeneration
...
def main():
    ...
    print("Testing print_gpu_status")
    print_gpu_status()
    ...
    if args.tokenizer_name:
        ...
        if args.model_name_or_path == 'google/pegasus-xsum':
    ...
    if args.model_name_or_path:
        if args.model_name_or_path == 'google/pegasus-xsum':
            logger.info("Using google/pegasus-xsum")
            logger.info("Using google/pegasus-xsum")
            logger.info("Using google/pegasus-xsum")
            logger.info("Using google/pegasus-xsum")
            logger.info("Using google/pegasus-xsum")
